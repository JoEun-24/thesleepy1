...
$(function(){
    ...
    addItem('', './musics/03.png', './musics/00.mp3');
    addItem('', './musics/04.png', './musics/01.mp3');
    addItem('', './musics/05.png', './musics/02.mp3');
    addItem('', './musics/06.png', './musics/00.mp3');
    addItem('', './musics/07.png', './musics/01.mp3');
    ...
    function setPosition(index){
        let pos = 0.5 * window.innerWidth - 82.5 - 205 * index;
